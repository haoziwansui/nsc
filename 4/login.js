...
　　  }
      ...
      { 	
      	...
      	var data="username="+trim(uname)+"&password="+pass2+"&drop="+drop+"&type=1&n=100";
      	
      	var con=postData("http://localhost/project4/register.php", "post", data);
      	//alert(con); 
      	var p=/^[\d]+$/;
      	if(p.test(con))
      	{
     ...
     function force_logout()
     {
      	...
      	if(uname == "")
      	{
      		con=postData("http://localhost/project4/register.php", "get", "");
      	}
      	else
      	{
      		var drop=(document.form1.drop.checked==true)?1:0;
      		var data="username="+trim(uname)+"&password="+pass+"&drop="+drop+"&type=1&n=1";
      		con=postData("http://localhost/project4/register.php", "post", data);
      	}
      	//alert(con);
      	switch(con)
      	{
	...
	function do_chk(frm)
	{
		...
		var res = postData("http://localhost/project4/register.php","post", d);
